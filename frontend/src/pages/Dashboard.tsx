...
function EmptyState({ onConnect }: { onConnect: () => void }) {
  return (
    ...
    >
      ...
      <h3 className="text-xl font-semibold text-slate-900 mb-2">No repositories connected</h3>
    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-slate-500 mt-1">Manage your repositories and AI analysis</p>
        </div>
        <motion.button 
            ...
            >
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-semibold text-slate-900 truncate max-w-[150px]">{r.name}</h3>
                </div>
                <span className="inline-flex items-center gap-1.5 text-xs bg-green-100 text-green-700 px-2.5 py-1 rounded-full border border-green-200">
                  <CheckCircle2 className="w-3 h-3" />
                  Active
                </span>
              </div>
              <p className="text-xs text-slate-500 truncate mb-2 font-mono bg-slate-50 px-2 py-1 rounded">{r.git_url}</p>
              <p className="text-xs text-slate-400 mb-4">Branch: <span className="text-slate-600">{r.default_branch}</span></p>
              ...
              <div className="flex gap-2">
                ...
                <button 
                  ...
                  className="px-3 py-2 bg-slate-100 hover:bg-red-50 text-slate-500 hover:text-red-600 rounded-lg transition-colors border border-slate-200 hover:border-red-200"
                >
      ...
      <AnimatePresence>
        {showModal && (
          ...
          >
            ...
            >
              <h2 className="text-xl font-semibold text-slate-900 mb-6">Connect Repository</h2>
